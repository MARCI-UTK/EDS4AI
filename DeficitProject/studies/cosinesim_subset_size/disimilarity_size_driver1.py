...
if __name__ == '__main__' :
    ...
    for size in subset_size:
        ...
        exp1['output_dir'] = 'studies/cosinesim_subset_size/different_size_disimilarity'

        trainset, testset = None, None

        quantiles = np.load('studies/cosinesim_subset_size/CIFAR10_train_cosinesim_quantiles.npy')
