...
durations = [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520]
post_duration = 250
...
if __name__ == '__main__' :
    ...
    for deficit_duration in durations:
        ...
        exp1['output_dir'] = 'studies/deficit_removal/disimilarity_AVG'
