...
exp1 = {
    ...
    'deficit_params' : {'start_epoch':0, 'type':'similarity', 
...
#durations = [0, 20, 40, 80, 120, 160, 200, 400, 440]
durations = [0, 20, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520]
...
if __name__ == '__main__' :
    ...
    for deficit_duration in durations:
        ...
        exp1['deficit_params']['subset_size'] = 0.1
        exp1['num_epochs'] = deficit_duration + post_duration
        exp1['output_dir'] = 'studies/deficit_removal/similarity_AVG'
