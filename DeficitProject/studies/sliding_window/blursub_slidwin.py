...
exp1 = {
    ...
    'deficit_module' : 'implementations.deficits.BlurSubsetDeficit',
    'deficit_name' : 'BlurSubsetDeficit',
...
#onsets = [50, 60, 70, 80, 100]
#onsets = [40, 50, 60, 70, 80, 100]
onsets = [0, 10, 20, 30, 40, 50, 60, 80, 100]
#onsets = [0, 5, 10, 15, 20, 30, 40, 100]
#subset_sizes = [0.9, 0.7]
#subset_sizes = [0.8]
subset_sizes = [1]
post_duration = 250
        ...
        for subset_size in subset_sizes:
            for onset in onsets:
                for deficit_duration in durations:
                    ...
                    exp1['output_dir'] = 'studies/sliding_window/blursubset'
