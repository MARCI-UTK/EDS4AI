...
exp1 = {
    ...
    'deficit_params' : {'root_dir':'../data', 'data':'CIFAR10', 'type':'similarity'},
...
window_durations = [40]
onsets = [0, 10, 20, 30, 40, 60, 80, 120, 160]
subset_sizes = [0.1]
...
if __name__ == '__main__' :
    ...
    for subset_size in subset_sizes:
        for onset in onsets:
            for deficit_duration in window_durations:
                ...
                exp1['output_dir'] = 'studies/sliding_window/similarity'
                ...
                experiment.train_model(verbose=args.v)